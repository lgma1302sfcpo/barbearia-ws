...
export default function Home() {
  ...
  function openAppointmentsWithoutMovingPage() {
    ...
    <main className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-[#172b36] text-white shadow-sm">
        <div className="mx-auto flex max-w-[1480px] flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-8">
          ...
          <div className="order-2 flex gap-2 sm:order-3"><Button variant="ghost" className="h-9 text-white/70 hover:bg-white/10 hover:text-white" onClick={() => void logout()}><LogOut /> Bloquear</Button><Button className="h-9 bg-[#f2a24a] px-3 font-bold text-[#172b36] hover:bg-[#ffb65f]" onClick={openAppointmentsWithoutMovingPage}><Plus /> Lançar</Button></div>
        </div>
      </header>
